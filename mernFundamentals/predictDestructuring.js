...
//Predict the output
console.log(name); // run error, stops here, reference error, name is not defined
...
const { password: hashedPassword } = person;  // no 'password' property in object, run error stops here
//Predict the output
console.log(password); // logs
